...
def train():
    ...
    df.to_csv(os.path.join(save_dir, 'hist_ghostnet.csv'), encoding='utf-8', index=False)
    ...
    # lock = _thread.RLock()
    # print(lock.acquire())
    # tf.saved_model.save(model, "mura_ghostnet.h5")
    model.save_weights("mura_ghostnet_test.h5") #保存模型
    # with open("mura_ghostnet.json", "w") as fp:
        # fp.write(model.to_json())
    # model.save_weights("mura_ghostnet.h5")
