...
def train():
    ...
    model = ShuffleNet(groups=3,pooling='avg',classes=n_class) #groups=3
    ...
    df.to_csv(os.path.join(save_dir, 'hist_shuffle.csv'), encoding='utf-8', index=False)
    ...
    model.save_weights("mura_shufflenet.h5") #保存模型
    print("***")
