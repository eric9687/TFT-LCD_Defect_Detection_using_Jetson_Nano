...
from tensorflow.keras.layers import Conv2D, BatchNormalization, Activation, GlobalAveragePooling2D, Lambda, Reshape, Dropout

from GhostNetBase_v2 import GBNeck
...
class GhostNet(Model):
    ...
    def __init__(self, classes):
        ...
        self.dwkernels = [3, 5, 5, 3, 5] #3, 3, 3, 5, 5, 3, 3, 3, 3, 3, 3, 5, 5, 5, 5, 5
        self.strides = [1, 2, 1, 2, 1 ] #1, 2, 1, 2, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1
        self.exps = [ 72, 72, 120, 240, 960] #16, 48, 72, 72, 120, 240, 200, 184, 184, 480, 672, 672, 960, 960, 960, 960
        self.outs = [ 24, 40, 40, 80, 160] #16, 24, 24, 40, 40, 80, 80, 80, 80, 112, 112, 160, 160, 160, 160, 160
        self.ratios = [2] * 5 #16
        self.use_ses = [False, True, True, False,True]
                        #False, False, False, True, True, False, False, False,   False, True, True, True, False, True, False, True
